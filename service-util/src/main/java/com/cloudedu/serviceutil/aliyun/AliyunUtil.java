package com.cloudedu.serviceutil.aliyun;
...
import com.cloudedu.serviceutil.config.SystemUtil;
import com.cloudedu.serviceutil.enums.PlatformEnum;
import com.cloudedu.serviceutil.tools.StrUtil;
...
public final class AliyunUtil {
    ...
    public static String getUrlSign(Aliyun aliyun, String url, Date expires){
        GeneratePresignedUrlRequest generatePresignedUrlRequest = new GeneratePresignedUrlRequest(aliyun.getAliyunOssBucket(),
                url.replace(aliyun.getAliyunOssUrl(),""));
        generatePresignedUrlRequest.setExpiration(expires);
        return url + "?" + getOssClient(SystemUtil.ALIYUN_OSS_ENDPOINT, aliyun.getAliyunAccessKeyId(),
                aliyun.getAliyunAccessKeySecret()).generatePresignedUrl(generatePresignedUrlRequest).getQuery();
    }
